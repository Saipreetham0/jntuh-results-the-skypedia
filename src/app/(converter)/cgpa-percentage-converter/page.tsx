...
const GradeScales: Record<string, GradeScale> = {
  "4.0": {
    max: 4.0,
    percentageMultiplier: 25,
    description: "US Grading System",
  },
  "5.0": {
    max: 5.0,
    percentageMultiplier: 20,
    description: "German Grading System",
  },
  "10.0": {
    max: 10.0,
    percentageMultiplier: 9.5,
    description: "Indian Grading System (JNTUH)",
  },
};
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center mb-4 p-5 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border-2 border-gray-100 dark:border-gray-700">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-[#1C61E7] font-semibold mt-0.5">
                To Percentage
              </p>
            </div>
          </div>
          <p className="text-gray-600 dark:text-gray-300 text-base max-w-2xl mx-auto">
            Convert your CGPA to percentage across multiple international
            grading scales
          </p>
        </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                  Multiplier: {GradeScales[scale].percentageMultiplier}x (
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-xl border-2 border-gray-200 dark:border-gray-700 shadow-md">
                  ...
                  <p
                    className={`text-3xl font-bold mb-1 ${getPerformanceLevel(result.percentage).color}`}
                  >
                ...
                <div className="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-xl border-2 border-gray-200 dark:border-gray-700 col-span-2 shadow-md">
                  ...
                  <p className="text-base font-semibold text-gray-900 dark:text-white">
                    {result.cgpa.toFixed(2)} ×{" "}
                    {GradeScales[scale].percentageMultiplier} ={" "}
                    {result.percentage.toFixed(2)}%
                  </p>
        ...
        {/* Bottom Ad */}
        <ResponsiveAd
          adSlot={AD_SLOTS.CALCULATOR.BOTTOM_RECTANGLE}
          format="auto"
          className="mt-8"
        />
      </div>
