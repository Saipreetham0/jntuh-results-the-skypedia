      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-x-3">
            ...
            <button className="p-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full relative">
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <div className="py-6 space-y-6">
                    ...
                    {/* Notification count */}
                    <div className="flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-900 dark:text-gray-200 bg-gray-50 dark:bg-gray-800 rounded-lg">
