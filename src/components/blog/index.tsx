      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center mb-8 md:mb-10 lg:mb-12 gap-2.5 md:gap-3">
          {categories.map((category, index) => (
            <button
              ...
              className={`px-6 py-3 md:px-7 md:py-3.5 rounded-xl text-sm md:text-sm font-bold transition-all duration-300 transform active:scale-95 md:hover:scale-105 min-h-[48px] ${
                activeTab === category
        ...
        <div className="grid gap-5 md:gap-6 lg:gap-8 md:grid-cols-2 lg:grid-cols-3">
          {filteredPosts.map((post) => (
            ...
            >
              <article
                className={`h-full flex flex-col bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-all duration-500 active:scale-[0.98] border-2 border-gray-200 dark:border-gray-700 ${
