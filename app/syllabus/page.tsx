...
const SyllabusCard: React.FC<{
  ...
  <div
    ...
    onClick={() => onItemClick(item)}
  >
    <h3 className="font-semibold text-lg">{item.course || item.syllabusName || item.name}</h3>
    {item.link.endsWith(".pdf") && <p className="text-sm text-green-600">PDF Available</p>}
  </div>
);
...
const SyllabusComponent: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-4xl font-bold mb-6 text-center text-gray-800 dark:text-white">JNTUH Syllabus</h1>
